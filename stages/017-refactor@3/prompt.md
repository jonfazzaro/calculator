...
- **baseline**: succeeded
  ...
  - Output:
    ...
    /repos/jonfazzaro/calculator/src/index.ts
      40:8   error  Function 'evaluateSpokenExpression' has too many lines (34). Maximum allowed is 20  max-lines-per-function
      55:27  error  Refactor this function to reduce its Cognitive Complexity from 8 to the 5 allowed   sonarjs/cognitive-complexity
      55:27  error  Arrow function has too many statements (15). Maximum allowed is 12                  max-statements
      55:27  error  Arrow function has a complexity of 8. Maximum allowed is 5                          complexity
