...
- **baseline**: succeeded
  ...
  - Output:
    ...
    /repos/jonfazzaro/calculator/src/index.ts
      ...
      42:27  error  Refactor this function to reduce its Cognitive Complexity from 7 to the 5 allowed   sonarjs/cognitive-complexity
      42:27  error  Arrow function has too many statements (16). Maximum allowed is 12                  max-statements
      42:27  error  Arrow function has a complexity of 7. Maximum allowed is 5                          complexity
