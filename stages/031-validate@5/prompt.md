...
- **baseline**: succeeded
  ...
  - Output:
    ...
    /repos/jonfazzaro/calculator/src/index.ts
      38:8   error  Function 'evaluateSpokenExpression' has too many lines (46). Maximum allowed is 20  max-lines-per-function
      69:3   error  Function 'read' has too many statements (14). Maximum allowed is 12                 max-statements
      69:3   error  Function 'read' has a complexity of 7. Maximum allowed is 5                         complexity
      69:12  error  Refactor this function to reduce its Cognitive Complexity from 7 to the 5 allowed   sonarjs/cognitive-complexity
...
- **evidence**: succeeded
  ...
  - Output:
    ...
    [2m   Start at [22m 13:13:15
    [2m   Duration [22m 433ms[2m (transform 14ms, setup 0ms, import 19ms, tests 369ms, environment 0ms)[22m
