...
- **baseline**: succeeded
  ...
  - Output:
    ...
    /repos/jonfazzaro/calculator/src/index.ts
      27:8   error  Function 'evaluateSpokenExpression' has too many lines (43). Maximum allowed is 20  max-lines-per-function
      42:27  error  Arrow function has too many lines (21). Maximum allowed is 20                       max-lines-per-function
      42:27  error  Refactor this function to reduce its Cognitive Complexity from 10 to the 5 allowed  sonarjs/cognitive-complexity
      42:27  error  Arrow function has too many statements (14). Maximum allowed is 12                  max-statements
      42:27  error  Arrow function has a complexity of 10. Maximum allowed is 5                         complexity
...
- **evidence**: succeeded
  ...
  - Output:
    ...
    [1m[30m[46m RUN [49m[39m[22m [36mv4.1.11 [39m[90m/repos/jonfazzaro/calculator[39m
     ...
     [32m✓[39m test/calculator.test.ts [2m([22m[2m9 tests[22m[2m)[22m[33m 369[2mms[22m[39m
    
    [2m Test Files [22m [1m[32m1 passed[39m[22m[90m (1)[39m
    [2m      Tests [22m [1m[32m9 passed[39m[22m[90m (9)[39m
    [2m   Start at [22m 00:28:34
    [2m   Duration [22m 432ms[2m (transform 14ms, setup 0ms, import 19ms, tests 369ms, environment 0ms)[22m
...
Given the working diff and validator findings from the preceding stages, write the commit message for the completed refactoring. Use a subject line under 72 characters, a blank line, then two or three lines explaining what changed and which success criteria it moved.

Do not run or edit anything. Emit only the commit message.
