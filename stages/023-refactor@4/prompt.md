...
- **baseline**: succeeded
  ...
  - Output:
    ...
    /repos/jonfazzaro/calculator/src/index.ts
      ...
      64:3   error  Function 'read' has too many statements (14). Maximum allowed is 12                 max-statements
      64:3   error  Function 'read' has a complexity of 7. Maximum allowed is 5                         complexity
      64:12  error  Refactor this function to reduce its Cognitive Complexity from 7 to the 5 allowed   sonarjs/cognitive-complexity
